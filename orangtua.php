                ...
                <div class="row">
                  ...
                  <div class="col-md-9">       
                    ...
                    <table border="0">
                      ...
                      $query=mysqli_query($koneksi, "SELECT * FROM siswa join kelas on kelas.id_kelas=siswa.id_kelas join orang_tua on orang_tua.id_ortu=siswa.id_ortu join guru on guru.id_guru=siswa.id_guru where orang_tua.id_ortu= '".$_SESSION['ID_ORTU']."'");
