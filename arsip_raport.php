        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Arsip Data Raport</li>
            </ol>                    
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-3 mt-3">
                    <input type = "button" onclick = "ajaxFunction()" class="btn btn-secondary mt-2" value ="FILTER"/>
                  </div>
                </div>
                <div id="txtHint">
      ...
      <script>
        function ajaxFunction() {          
          ...
          var tahun = document.getElementById('tahun').value;
            ...
            xmlhttp.open("GET","data_arsip?kelas="+kelas+"&tahun="+tahun, true);
            xmlhttp.send();
          }
        </script>
      </script>
