      ...
      <li class="nav-item">
        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            include 'koneksi.php';
            $id = $_GET['id'];
            $query = mysqli_query($koneksi, "SELECT * FROM MAPEL where kd_mapel = '$id' ");
            while($data = mysqli_fetch_array($query)){
              ?>
              <form method="POST" action="update_mapel" enctype="multipart/form-data" class="col-md-12">
                <div class="row">
                  <div class="col-md-4">  
                  <input type="hidden" name="id" value="<?php echo"$data[KD_MAPEL]";?>">              

                    <div class="form-group">
                      <label for="Password Siswa">Kode Mapel</label>
                      <input value="<?php echo"$data[KD_MAPEL]";?>"  type="text" class="form-control" name="kode">
                    </div>

                    <div class="form-group">
                      <label for="Password Orang Tua">Nama Mapel</label>
                      <input value="<?php echo"$data[MAPEL]";?>"  type="text" class="form-control" name="nama">
                    </div>                   
