      ...
      <li class="nav-item">
        ...
        <div id="content-wrapper">
         ...
         function ajaxFunction() {
          var tanggal = document.getElementById('ajax').value;
          var kelas = document.getElementById('kelas').value;
            ...
            xmlhttp.open("GET","table-absensi?ajax="+tanggal+"&kelas="+kelas, true);
            xmlhttp.send();
          ...
          //   ajaxRequest.open("GET", "table-absensi?ajax="+ajax+"&kelas="+ kelas, true);
