        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            while($data = mysqli_fetch_array($query)){
              ?>
              <form method="POST" action="update_guru" enctype="multipart/form-data" class="col-md-12">
                <div class="row">
                  <div class="col-md-4">                
                    <input type="hidden" name="id" value="<?php echo"$data[ID_GURU]";?>">
                    <div class="form-group">
                      <label for="Password Siswa">Nama Guru</label>
                      <input value="<?php echo"$data[NAMA_GURU]";?>"  type="text" class="form-control" name="nama">
                    </div>

                    <div class="form-group">
                      <label for="Password Orang Tua">Tanggal Lahir Guru</label>
                      <input value="<?php echo"$data[TGL_LAHIR_GURU]";?>"  type="date" class="form-control" name="tanggal">
                    </div>                   

                  </div>
                  <div class="col-md-4">
                   <div class="form-group">
                    <label for="Password Orang Tua">No HP Guru</label>
                    <input value="<?php echo"$data[NO_HP_GURU]";?>"  type="text" class="form-control" name="hp">
                  </div>
                  <div class="form-group">
                    <label for="Password Orang Tua">Email Guru</label>
                    <input value="<?php echo"$data[EMAIL_GURU]";?>"  type="text" class="form-control" name="email">
                  </div> 
                </div>
              </div>
