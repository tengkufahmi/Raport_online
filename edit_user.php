        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            while($data = mysqli_fetch_array($query)){
              ?>
            <form method="POST" action="update_user" enctype="multipart/form-data" class="col-md-12">
              <div class="row">
                <div class="col-md-4">                
                  ...
                  <div class="form-group">
                    ...
                    <input value="<?php echo"$data[PASSWORD]";?>"  type="text" class="form-control" name="password">
                  </div>
