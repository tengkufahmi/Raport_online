      ...
      <li class="nav-item">
        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            ?>
            <form method="POST" action="update_pengumuman" enctype="multipart/form-data" class="col-md-12">
              <div class="row">
                <div class="col-md-8">
                  <input type="hidden" name="id" value="<?php echo"$data[ID_PENGUMUMAN]"; ?>">
                  <div class="form-group">
                    <label for="judul berita">Judul Pengumuman</label>
                    <input value="<?php echo"$data[JUDUL]"; ?>" type="text" class="form-control" name="judul">
                  </div>
                  <div class="form-group">
                    <label for="isi">Isi</label>
                    <textarea name="isi" rows="4" cols="50" class="form-control"><?php echo"$data[ISI]"; ?></textarea>                    
                  </div>
