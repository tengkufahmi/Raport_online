                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      <thead>
                        ...
                        <tbody>
                          <?php
                          include 'koneksi.php';
                          $query=mysqli_query($koneksi, "call pengumuman()");
                          while($data = mysqli_fetch_array($query)){
                            ...
                            <tr>
                              ...
                              <td>
                              <a href="edit_pengumuman?id=<?php echo"$data[ID_PENGUMUMAN]";?>" class="btn btn-info" >Ubah</a>
                              <a href="delete_pengumuman?id=<?php echo"$data[ID_PENGUMUMAN]";?>" class="btn btn-danger" >Hapus</a>
                              </td>
